...
describe('EndpointList', () => {
  ...
  it('dispara as ações do endpoint ativo', () => {
    const onTest = vi.fn()
    const onEdit = vi.fn()
    const onDelete = vi.fn()

    render(<EndpointList endpoints={[endpoint]} onTest={onTest} onEdit={onEdit} onDelete={onDelete} />)
  ...
  it('não permite testar um endpoint inativo', () => {
    render(<EndpointList endpoints={[{ ...endpoint, active: 'N' }]} onTest={vi.fn()} onEdit={vi.fn()} onDelete={vi.fn()} />)
